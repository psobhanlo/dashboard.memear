                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('user.store') }}" class="forms-sample" >
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input name="name" value="{{ old('name') }}" type="text" class="form-control" id="desginer_name" placeholder="{{__('input.desginer_name')}} {{__('input.placeholder')}}">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="mobile" class="col-sm-3 col-form-label"> {{__('input.mobile')}}</label>
                      <div class="col-sm-9">
                        <input name="mobile"  value="{{ old('mobile') }}" class="form-control" id="mobile" placeholder="{{__('input.mobile')}} {{__('input.placeholder')}}">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="password" class="col-sm-3 col-form-label">{{__('input.password')}}</label>
                      <div class="col-sm-9">
                        <input name="password" value="{{ old('password') }}" type="password" class="form-control" id="password" placeholder="{{__('input.password')}} {{__('input.placeholder')}}">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="commission"  class="col-sm-3 col-form-label">{{__('input.commission')}}</label>
                      <div class="col-sm-9">
                        <input name="commission" value="{{ old('commission') }}"  type="number" class="form-control" id="commission" placeholder="{{__('input.commission')}} {{__('input.placeholder')}}">
                      </div>
                    </div>
